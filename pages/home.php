...
<div class="container">
        ...
        <div style="border-radius: var(--radius); overflow: hidden; position: relative;">
            ...
            <div class="hero-content" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; color: white; width: 90%;">
                ...
                <div class="banner-search-group">
                    <select><option>Tất cả loại hình</option><option>Nhà phố</option><option>Đất nền</option></select>
                    <select><option>Toàn quốc</option><option>Hồ Chí Minh</option><option>Hà Nội</option></select>
                    <select><option>Mức giá</option><option>< 3 Tỷ</option><option>3 - 10 Tỷ</option></select>
            ...
            <div style="display: flex; flex-direction: column; gap: 15px;">
             ...
             <div style="display: flex; flex-direction: column; gap: 15px;">
                <div style="flex: 1; position: relative; border-radius: 8px; overflow: hidden;">
                    ...
                    <div style="position: absolute; bottom: 15px; left: 20px; color: white; font-weight: bold; text-shadow: 1px 1px 3px black; font-size: 18px;">BÌNH DƯƠNG</div>
                </div>
                <div style="flex: 1; position: relative; border-radius: 8px; overflow: hidden;">
                    ...
                    <div style="position: absolute; bottom: 15px; left: 20px; color: white; font-weight: bold; text-shadow: 1px 1px 3px black; font-size: 18px;">ĐỒNG NAI</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="margin-bottom: 60px; background-image: url('https://images.unsplash.com/photo-1556912173-3db996e16054?w=1200&q=80'); background-size: cover; background-attachment: fixed; padding: 80px 20px; text-align: center; border-radius: 8px; position: relative;">
        ...
        <div style="position: relative; z-index: 2; color: white;">
            ...
            <a href="#" style="background: var(--accent); color: white; padding: 15px 40px; border-radius: 50px; font-weight: bold; font-size: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.3);">KÝ GỬI NGAY</a>
        </div>
    </section>
